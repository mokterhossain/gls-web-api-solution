...
{
    [NotMapped]
    public class ProjectSampleViewModel : ProjectSample
    {
        ...
        public string LabelDynamicField { get; set; }

        public List<ProjectSampleDetailViewModel> ProjectSampleDetail { get; set; }
